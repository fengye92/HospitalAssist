...
<html>
	...
	<!-- jQuery -->
	<script type="text/javascript" charset="utf8" src="js/jquery-1.11.0.js"></script>
  	<!-- Bootstrap Core JavaScript -->
	<script src="js/bootstrap.min.js"></script>
	
	<!-- DataTables -->
	<script type="text/javascript" charset="utf8" src="js/plugins/jquery.dataTables.min.js"></script>
